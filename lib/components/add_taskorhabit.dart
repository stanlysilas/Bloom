...
class AddTaskOrHabitModalState extends State<AddTaskOrHabitModal> {
  ...
  Future<void> addToFirebase(DateTime dateTime) async {
    ...
    // Add notificationID to the list
    await FirebaseFirestore.instance.collection('users').doc(userId).update({
      'notificationIds': FieldValue.arrayUnion([uniqueId]),
    });
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: [
                  RawAutocomplete<String>(
                    ...
                    fieldViewBuilder: (context, taskGroupsController, focusNode,
                        onFieldSubmitted) {
                      ...
                      endIcon: Switch(
                          ...
                          onChanged: (value) async {
                            ...
                            if (isHabit) {
                              ...
                              showHabitIntroDialog(isHabitIntroShown ?? false);
                            }
                          }),
                    ),
                    if (isHabit)
            ...
            if (MediaQuery.of(context).size.width < mobileWidth) const Spacer(),
            // Submit button
            Padding(
              padding:
